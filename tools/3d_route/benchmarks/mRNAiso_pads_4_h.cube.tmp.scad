translate(v = [-0.5, -0.5, 0]) {
	...
	union() {
		...
		union() {
			...
			translate(v = [2.5, 3.5, 3.5]) {
				rotate(a = [0, 150.7940677526006, 26.56505117707799]) {
			...
			translate(v = [-2.5, 3.5, 3.5]) {
				rotate(a = [0, 78.69006752597979, -53.13010235415598]) {
					cube(size = [0.125, 0.125, 5.0990195135927845]);
				}
			}
	...
	union() {
		...
		union() {
			...
			translate(v = [-4.5, 5.5, 1.5]) {
				rotate(a = [0, 67.01023222639115, -45.0]) {
			...
			translate(v = [5.5, 0.5, 5.5]) {
				rotate(a = [0, 98.87639508097335, -141.34019174590992]) {
					cube(size = [0.125, 0.125, 6.48074069840786]);
				}
			}
			/*Edge 63 from bank.push_flush_hole to $_63*/
			translate(v = [5.5, 4.5, 5.5]) {
				rotate(a = [0, 98.87639508097335, -128.6598082540901]) {
					cube(size = [0.125, 0.125, 6.48074069840786]);
				}
			}
			...
			translate(v = [1.5, -3.5, 0.5]) {
				rotate(a = [0, 30.963756532073536, 90.0]) {
			...
			translate(v = [1.5, -3.5, 0.5]) {
				rotate(a = [0, 45.00000000000001, 36.86989764584402]) {
					cube(size = [0.125, 0.125, 7.0710678118654755]);
				}
			}
	...
	union() {
		...
		union() {
			...
			translate(v = [2.5, 0.5, 6.5]) {
				rotate(a = [0, 130.61285517607675, -59.03624346792648]) {
					cube(size = [0.125, 0.125, 7.681145747868608]);
				}
			}
