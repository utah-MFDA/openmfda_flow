translate(v = [-0.5, -0.5, 0]) {
	...
	union() {
		...
		union() {
			...
			translate(v = [0.5, 18.5, 21.5]) {
				rotate(a = [0, 54.735610317245346, 45.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 26 from bank.lysis_out_flush_hole to $_26*/
			translate(v = [0.5, 18.5, 25.5]) {
