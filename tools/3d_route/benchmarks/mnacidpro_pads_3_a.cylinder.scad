translate(v = [-0.5, -0.5, 0]) {
	...
	union() {
		...
		union() {
			...
			translate(v = [9.5, 7.5, 25.5]) {
				rotate(a = [0, 90.0, -98.130102354156]) {
					cube(size = [0.125, 0.125, 7.0710678118654755]);
				}
			}
			/*Edge -1 from $_8__6 to $_8__7*/
			translate(v = [8.5, 9.5, 15.5]) {
				rotate(a = [0, 130.31554221077258, -171.86989764584402]) {
			...
			translate(v = [8.5, 9.5, 25.5]) {
				rotate(a = [0, 90.0, -171.86989764584402]) {
					cube(size = [0.125, 0.125, 7.0710678118654755]);
				}
			}
			...
			translate(v = [7.5, 9.5, 23.5]) {
				rotate(a = [0, 134.7106224551696, -171.86989764584402]) {
					cube(size = [0.125, 0.125, 9.9498743710662]);
				}
			}
			...
			translate(v = [8.5, 9.5, 23.5]) {
				rotate(a = [0, 98.130102354156, -90.0]) {
					cube(size = [0.125, 0.125, 7.0710678118654755]);
				}
			}
