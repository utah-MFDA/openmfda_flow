translate(v = [-0.5, -0.5, 0]) {
	...
	union() {
		...
		union() {
			...
			translate(v = [1.5, 4.5, 17.5]) {
				rotate(a = [0, 90.0, -36.86989764584402]) {
	...
	union() {
		...
		union() {
			...
			translate(v = [-11.5, -9.5, -18.5]) {
				rotate(a = [0, 45.00000000000001, 0.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 58 from thing.dead_end_ctrl_hole to $_58*/
			translate(v = [-11.5, -7.5, -18.5]) {
				rotate(a = [0, 90.0, 45.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
	...
	union() {
		...
		union() {
			...
			translate(v = [-12.5, -11.5, -22.5]) {
				rotate(a = [0, 11.309932474020195, 0.0]) {
					cube(size = [0.125, 0.125, 5.0990195135927845]);
				}
			}
			...
			translate(v = [-12.5, -10.5, -24.5]) {
				rotate(a = [0, 39.50971228619393, -14.036243467926477]) {
					cube(size = [0.125, 0.125, 6.48074069840786]);
				}
			}
