	...
	union() {
		...
		union() {
			...
			translate(v = [3.5, 3.5, 2.5]) {
				rotate(a = [0, 71.06817681913482, -149.03624346792648]) {
					cube(size = [0.125, 0.125, 6.164414002968976]);
				}
			}
			/*Edge 12 from bank.lysis_in_ctrl_hole to $_12*/
			translate(v = [-2.5, 3.5, 3.5]) {
				rotate(a = [0, 80.26852452684238, -30.96375653207352]) {
					cube(size = [0.125, 0.125, 5.916079783099616]);
				}
			}
			...
			translate(v = [1.5, -2.5, 3.5]) {
				rotate(a = [0, 108.9318231808652, 59.03624346792648]) {
					cube(size = [0.125, 0.125, 6.164414002968976]);
				}
			}
			...
			translate(v = [4.5, 1.5, 2.5]) {
				rotate(a = [0, 138.1896851042214, -153.43494882292202]) {
					cube(size = [0.125, 0.125, 6.708203932499369]);
				}
			}
			/*Edge 57 from $_57 to bank.thing.devices[0].thingy.vpump1*/
			translate(v = [4.5, 1.5, 2.5]) {
				rotate(a = [0, 100.51973489065863, 158.19859051364818]) {
			...
			translate(v = [4.5, 4.5, 2.5]) {
				rotate(a = [0, 130.61285517607675, -120.96375653207352]) {
					cube(size = [0.125, 0.125, 7.681145747868608]);
				}
			}
			...
			translate(v = [0.5, 3.5, 3.5]) {
				rotate(a = [0, 120.96375653207352, -36.86989764584402]) {
	...
	union() {
		...
		union() {
			...
			translate(v = [5.5, 5.5, -0.5]) {
				rotate(a = [0, 47.12401133336428, -111.80140948635182]) {
			...
			translate(v = [4.5, 4.5, 4.5]) {
				rotate(a = [0, 76.73732399169515, -135.0]) {
					cube(size = [0.125, 0.125, 4.358898943540674]);
				}
			}
			...
			translate(v = [4.5, 1.5, 2.5]) {
				rotate(a = [0, 59.03624346792648, 126.86989764584402]) {
					cube(size = [0.125, 0.125, 5.830951894845301]);
				}
			}
			...
			translate(v = [4.5, 0.5, 3.5]) {
				rotate(a = [0, 74.20683095173604, 135.0]) {
					cube(size = [0.125, 0.125, 7.3484692283495345]);
				}
			}
