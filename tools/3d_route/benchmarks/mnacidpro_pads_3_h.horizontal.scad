translate(v = [-0.5, -0.5, 0]) {
	...
	union() {
		...
		union() {
			...
			translate(v = [0.5, -24.5, -19.5]) {
				rotate(a = [0, 45.00000000000001, 0.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge -1 from $_37__0 to $_37__1*/
			translate(v = [1.5, -24.5, -16.5]) {
			...
			translate(v = [1.5, -23.5, -17.5]) {
				rotate(a = [0, 90.0, -135.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge -1 from $_36__0 to $_36__1*/
			translate(v = [1.5, -24.5, -17.5]) {
	...
	union() {
		...
		union() {
			...
			/*Node $_32*/
			color(alpha = 0.1, c = "pink") {
				translate(v = [14, -25, -20]) {
					cube(size = [1, 1, 1]);
				}
			}
			/*Node $_35*/
			color(alpha = 0.1, c = "pink") {
				translate(v = [14, -25, -21]) {
					cube(size = [1, 1, 1]);
				}
			}
			/*Node $_33*/
