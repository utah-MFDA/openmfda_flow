translate(v = [-0.5, -0.5, 0]) {
	...
	union() {
		...
		union() {
			...
			color(alpha = 0.1, c = "black") {
				translate(v = [11, 15, 18]) {
					cube(size = [1, 1, 1]);
				}
			}
			/*Node thing.thing.wash*/
			color(alpha = 0.1, c = "black") {
				translate(v = [11, 15, 20]) {
					cube(size = [1, 1, 1]);
				}
			}
		}
	...
	union() {
		...
		union() {
			...
			translate(v = [14.5, 12.5, 15.5]) {
				rotate(a = [0, 54.735610317245346, 135.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 34 from thing.wash_in_hole to $_34*/
			translate(v = [14.5, 12.5, 17.5]) {
				rotate(a = [0, 54.735610317245346, 135.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
	...
	union() {
		...
		union() {
			...
			/*Node $_33*/
			color(alpha = 0.1, c = "pink") {
				translate(v = [14, 12, 15]) {
					cube(size = [1, 1, 1]);
				}
			}
			/*Node $_34*/
			color(alpha = 0.1, c = "pink") {
				translate(v = [14, 12, 17]) {
					cube(size = [1, 1, 1]);
				}
			}
		}
