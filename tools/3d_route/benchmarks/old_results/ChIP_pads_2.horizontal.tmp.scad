translate(v = [-0.5, -0.5, 0]) {
	...
	union() {
		...
		union() {
			...
			/*Edge 120 from thingy.thingy.chamber[0].first.vcollect to $_120*/
			translate(v = [2.5, -7.5, 19.5]) {
				rotate(a = [0, 125.26438968275465, -45.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 120 from $_120 to thingy.thingy.chamber[1].first.vcollect*/
			translate(v = [3.5, -7.5, 18.5]) {
				rotate(a = [0, 45.00000000000001, 180.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 144 from thingy.thingy.prep.vout3 to $_144*/
			translate(v = [2.5, -7.5, 21.5]) {
				rotate(a = [0, 90.0, -45.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 145 from thingy.thingy.prep.vout3 to $_145*/
	...
	union() {
		...
		union() {
			...
			/*Edge 121 from thingy.thingy.chamber[0].first.vcollect to $_121*/
			translate(v = [4.5, -7.5, 17.5]) {
				rotate(a = [0, 54.735610317245346, -135.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 129 from $_129 to thingy.thingy.prep.vout3*/
			translate(v = [3.5, -8.5, 21.5]) {
				rotate(a = [0, 125.26438968275465, 45.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 136 from thingy.thingy.chamber[1].first.vcollect to $_136*/
	...
	union() {
		...
		union() {
			...
			/*Edge 121 from $_121 to thingy.thingy.chamber[0].first.vsieve*/
			translate(v = [5.5, -6.5, 18.5]) {
				rotate(a = [0, 125.26438968275465, -135.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			...
			/*Edge 129 from thingy.thingy.chamber[0].first.vring_in to $_129*/
			...
			/*Edge 129 from $_129 to thingy.thingy.chamber[1].first.vring_in*/
			translate(v = [5.5, -6.5, 20.5]) {
				rotate(a = [0, 90.0, -135.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 132 from thingy.thingy.chamber[0].first.vsieve to $_132*/
			translate(v = [4.5, -6.5, 17.5]) {
				rotate(a = [0, 45.00000000000001, 0.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 132 from $_132 to thingy.thingy.chamber[1].first.vsieve*/
			translate(v = [5.5, -7.5, 18.5]) {
				rotate(a = [0, 125.26438968275465, 135.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			...
			/*Edge 140 from thingy.thingy.prep.ring to $_140*/
			translate(v = [4.5, -7.5, 21.5]) {
				rotate(a = [0, 90.0, 45.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 140 from $_140 to thingy.thingy.prep.sv1*/
			translate(v = [5.5, -7.5, 21.5]) {
				rotate(a = [0, 90.0, 180.0]) {
					cube(size = [0.125, 0.125, 1.0]);
				}
	...
	union() {
		...
		union() {
			...
			/*Edge 116 from $_116 to thingy.thingy.chamber[0].first.vring_in*/
			translate(v = [5.5, -6.5, 19.5]) {
			...
			/*Edge 139 from thingy.thingy.prep.ring to $_139*/
			translate(v = [6.5, -4.5, 19.5]) {
				rotate(a = [0, 48.189685104221404, -116.56505117707799]) {
					cube(size = [0.125, 0.125, 3.0]);
				}
			}
			/*Edge 141 from thingy.thingy.prep.sv1 to $_141*/
			translate(v = [6.5, -6.5, 21.5]) {
				rotate(a = [0, 90.0, -135.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 141 from $_141 to thingy.thingy.prep.vout2*/
			translate(v = [5.5, -7.5, 23.5]) {
	...
	union() {
		...
		union() {
			...
			/*Edge 116 from thingy.thingy.chamber[0].first.ring to $_116*/
			translate(v = [6.5, -4.5, 17.5]) {
				rotate(a = [0, 90.0, 45.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 116 from $_116 to thingy.thingy.chamber[0].first.vpump3.valves[0].vinlet*/
			translate(v = [7.5, -3.5, 18.5]) {
				rotate(a = [0, 125.26438968275465, -135.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 123 from thingy.thingy.chamber[0].first.voutlet to $_123*/
			translate(v = [6.5, -2.5, 19.5]) {
				rotate(a = [0, 90.0, -63.43494882292201]) {
					cube(size = [0.125, 0.125, 2.23606797749979]);
				}
			}
			/*Edge 123 from $_123 to thingy.thingy.chamber[1].first.voutlet*/
			translate(v = [7.5, -2.5, 20.5]) {
				rotate(a = [0, 135.0, 180.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 127 from thingy.thingy.chamber[0].first.vpump3.valves[0].vinlet to $_127*/
			translate(v = [6.5, -3.5, 18.5]) {
				rotate(a = [0, 90.0, 0.0]) {
					cube(size = [0.125, 0.125, 1.0]);
				}
			}
			/*Edge 127 from $_127 to thingy.thingy.chamber[1].first.vpump3.valves[0].vinlet*/
			translate(v = [7.5, -3.5, 19.5]) {
				rotate(a = [0, 135.0, 180.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			...
			/*Edge 131 from thingy.thingy.chamber[0].first.vring_out to $_131*/
			translate(v = [6.5, -4.5, 16.5]) {
				rotate(a = [0, 90.0, 45.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 130 from $_130 to thingy.thingy.chamber[1].first.vring_out*/
			translate(v = [7.5, -4.5, 17.5]) {
				rotate(a = [0, 114.09484255211072, 116.56505117707799]) {
					cube(size = [0.125, 0.125, 2.449489742783178]);
				}
			}
			/*Edge 133 from thingy.thingy.chamber[1].first.ring to $_133*/
			...
			/*Edge 138 from thingy.thingy.chamber[1].first.vring_out to $_138*/
			translate(v = [6.5, -5.5, 17.5]) {
				rotate(a = [0, 90.0, 45.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 139 from $_139 to thingy.thingy.prep.v1*/
			translate(v = [7.5, -3.5, 20.5]) {
				rotate(a = [0, 125.26438968275465, -135.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 141 from $_141 to thingy.thingy.prep.v2*/
			translate(v = [7.5, -4.5, 21.5]) {
				rotate(a = [0, 90.0, -116.56505117707799]) {
					cube(size = [0.125, 0.125, 2.23606797749979]);
				}
	...
	union() {
		...
		union() {
			...
			/*Edge 117 from thingy.thingy.chamber[0].first.ring to $_117*/
			translate(v = [8.5, -3.5, 16.5]) {
				rotate(a = [0, 45.00000000000001, 180.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 117 from $_117 to thingy.thingy.chamber[0].first.vring_out*/
			translate(v = [7.5, -3.5, 16.5]) {
				rotate(a = [0, 90.0, 0.0]) {
					cube(size = [0.125, 0.125, 1.0]);
				}
			}
			/*Edge 124 from thingy.thingy.chamber[0].first.voutlet to $_124*/
			...
			/*Edge 134 from thingy.thingy.chamber[1].first.ring to $_134*/
			translate(v = [8.5, -3.5, 18.5]) {
				rotate(a = [0, 90.0, -135.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 134 from $_134 to thingy.thingy.chamber[1].first.vring_out*/
			translate(v = [7.5, -4.5, 17.5]) {
				rotate(a = [0, 54.735610317245346, 45.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 137 from thingy.thingy.chamber[1].first.voutlet to $_137*/
			translate(v = [8.5, -3.5, 19.5]) {
				rotate(a = [0, 54.735610317245346, 135.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 137 from $_137 to thingy.thingy.chamber[1].first.vpump3.valves[0].vinlet*/
			translate(v = [7.5, -3.5, 19.5]) {
				rotate(a = [0, 90.0, 0.0]) {
					cube(size = [0.125, 0.125, 1.0]);
				}
			}
			/*Edge 142 from thingy.thingy.prep.v1 to $_142*/
			translate(v = [8.5, -3.5, 20.5]) {
				rotate(a = [0, 90.0, 180.0]) {
					cube(size = [0.125, 0.125, 1.0]);
				}
			}
			/*Edge 142 from $_142 to thingy.thingy.prep.v2*/
			translate(v = [7.5, -4.5, 21.5]) {
				rotate(a = [0, 125.26438968275465, 45.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 142 from $_142 to thingy.thingy.prep.vout1*/
			translate(v = [7.5, -5.5, 21.5]) {
				rotate(a = [0, 114.09484255211072, 63.43494882292201]) {
					cube(size = [0.125, 0.125, 2.449489742783178]);
				}
	...
	union() {
		...
		union() {
			...
			/*Edge 124 from $_124 to thingy.thingy.chamber[0].first.vpump2.valves[0].vinlet*/
			translate(v = [9.5, -3.5, 17.5]) {
				rotate(a = [0, 54.735610317245346, -135.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 125 from thingy.thingy.chamber[0].first.vpump1.valves[0].vinlet to $_125*/
			translate(v = [8.5, -1.5, 16.5]) {
				rotate(a = [0, 90.0, -45.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 125 from $_125 to thingy.thingy.chamber[1].first.vpump1.valves[0].vinlet*/
			translate(v = [9.5, -2.5, 17.5]) {
				rotate(a = [0, 125.26438968275465, 135.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 126 from thingy.thingy.chamber[0].first.vpump2.valves[0].vinlet to $_126*/
			translate(v = [8.5, -2.5, 18.5]) {
				rotate(a = [0, 125.26438968275465, -45.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 126 from $_126 to thingy.thingy.chamber[1].first.vpump2.valves[0].vinlet*/
			translate(v = [9.5, -2.5, 18.5]) {
				rotate(a = [0, 90.0, 180.0]) {
					cube(size = [0.125, 0.125, 1.0]);
				}
			}
			/*Edge 134 from $_134 to thingy.thingy.chamber[1].first.vpump1.valves[0].vinlet*/
			translate(v = [9.5, -2.5, 17.5]) {
				rotate(a = [0, 54.735610317245346, -135.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			...
			/*Edge 142 from $_142 to thingy.thingy.prep.vin*/
			translate(v = [9.5, -3.5, 19.5]) {
				rotate(a = [0, 45.00000000000001, 180.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
	...
	union() {
		...
		union() {
			...
			/*Edge 119 from $_119 to thingy.thingy.chamber[0].first.vpump1.valves[0].vinlet*/
			translate(v = [9.5, -2.5, 16.5]) {
				rotate(a = [0, 90.0, 0.0]) {
					cube(size = [0.125, 0.125, 1.0]);
				}
			}
			/*Edge 119 from $_119 to thingy.thingy.chamber[0].first.vpump2.valves[0].vinlet*/
			translate(v = [9.5, -3.5, 17.5]) {
				rotate(a = [0, 125.26438968275465, 45.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			...
			/*Edge 135 from $_135 to thingy.thingy.chamber[1].first.vpump2.valves[0].vinlet*/
			translate(v = [9.5, -2.5, 18.5]) {
				rotate(a = [0, 135.0, 0.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 143 from thingy.thingy.prep.vin to $_143*/
			translate(v = [10.5, -3.5, 18.5]) {
				rotate(a = [0, 45.00000000000001, 180.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
	...
	union() {
		...
		union() {
			...
			/*Edge 118 from thingy.thingy.chamber[0].first.vbead to $_118*/
			translate(v = [10.5, -0.5, 15.5]) {
				rotate(a = [0, 54.735610317245346, -45.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 119 from thingy.thingy.chamber[0].first.vbead to $_119*/
			translate(v = [10.5, -2.5, 16.5]) {
				rotate(a = [0, 90.0, 45.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 118 from $_118 to thingy.thingy.chamber[1].first.vbead*/
			translate(v = [11.5, -0.5, 16.5]) {
				rotate(a = [0, 135.0, 180.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 119 from $_119 to thingy.thingy.chamber[0].first.vinlet*/
			translate(v = [11.5, -2.5, 15.5]) {
				rotate(a = [0, 45.00000000000001, 180.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 122 from thingy.thingy.chamber[0].first.vinlet to $_122*/
			translate(v = [10.5, -3.5, 15.5]) {
				rotate(a = [0, 90.0, 45.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 122 from $_122 to thingy.thingy.chamber[1].first.vinlet*/
			translate(v = [11.5, -2.5, 16.5]) {
				rotate(a = [0, 125.26438968275465, -135.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 135 from thingy.thingy.chamber[1].first.vbead to $_135*/
			translate(v = [10.5, -2.5, 17.5]) {
				rotate(a = [0, 114.09484255211072, 63.43494882292201]) {
					cube(size = [0.125, 0.125, 2.449489742783178]);
				}
			}
			/*Edge 135 from $_135 to thingy.thingy.chamber[1].first.vinlet*/
			translate(v = [11.5, -2.5, 16.5]) {
				rotate(a = [0, 45.00000000000001, 180.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 143 from $_143 to thingy.thingy.vinlet.valves[0].vinlet*/
			translate(v = [11.5, -3.5, 17.5]) {
				rotate(a = [0, 45.00000000000001, 180.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 143 from $_143 to thingy.thingy.vinlet.valves[1].vinlet*/
			translate(v = [11.5, -2.5, 17.5]) {
				rotate(a = [0, 54.735610317245346, -135.0]) {
					cube(size = [0.125, 0.125, 1.7320508075688772]);
				}
			}
			/*Edge 143 from $_143 to thingy.thingy.vinlet.valves[2].vinlet*/
			translate(v = [11.5, -2.5, 18.5]) {
				rotate(a = [0, 90.0, -135.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 143 from $_143 to thingy.thingy.vinlet.valves[3].vinlet*/
			translate(v = [11.5, -3.5, 19.5]) {
				rotate(a = [0, 135.0, 180.0]) {
					cube(size = [0.125, 0.125, 1.4142135623730951]);
				}
			}
			/*Edge 143 from $_143 to thingy.thingy.vinlet.valves[4].vinlet*/
			translate(v = [11.5, -3.5, 18.5]) {
				rotate(a = [0, 90.0, 180.0]) {
					cube(size = [0.125, 0.125, 1.0]);
				}
