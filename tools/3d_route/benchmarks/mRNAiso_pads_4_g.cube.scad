	...
	union() {
		...
		union() {
			...
			translate(v = [-1.5, 3.5, 3.5]) {
				rotate(a = [0, 144.20424008529292, -123.69006752597979]) {
			...
			translate(v = [1.5, 3.5, 2.5]) {
				rotate(a = [0, 124.44990198795351, -59.03624346792648]) {
			...
			translate(v = [0.5, -2.5, 3.5]) {
				rotate(a = [0, 131.4729343089405, 45.0]) {
			...
			translate(v = [2.5, -2.5, 3.5]) {
				rotate(a = [0, 132.87598866663575, 68.19859051364818]) {
			...
			translate(v = [0.5, 1.5, -3.5]) {
				rotate(a = [0, 21.801409486351794, 90.0]) {
	...
	union() {
		...
		union() {
			...
			translate(v = [0.5, -2.5, -4.5]) {
				rotate(a = [0, 56.145485187379485, 153.43494882292202]) {
					cube(size = [0.125, 0.125, 5.385164807134504]);
				}
			}
			/*Edge 45 from bank.cells_out_flush_hole to $_45*/
			translate(v = [0.5, 1.5, -4.5]) {
				rotate(a = [0, 59.03624346792648, -143.13010235415598]) {
	...
	union() {
		...
		union() {
			...
			translate(v = [-0.5, 6.5, -5.5]) {
				rotate(a = [0, 81.12360491902666, -128.6598082540901]) {
					cube(size = [0.125, 0.125, 6.48074069840786]);
				}
			}
