translate(v = [-0.5, -0.5, 0]) {
	...
	union() {
		...
		union() {
			...
			translate(v = [3.5, 1.5, 3.5]) {
				rotate(a = [0, 128.6598082540901, 143.13010235415598]) {
			...
			translate(v = [3.5, 0.5, 3.5]) {
				rotate(a = [0, 117.93835272960236, -135.0]) {
					cube(size = [0.125, 0.125, 6.4031242374328485]);
				}
			}
			...
			translate(v = [-2.5, 4.5, 0.5]) {
				rotate(a = [0, 59.03624346792648, -36.86989764584402]) {
			...
			translate(v = [-3.5, 0.5, 0.5]) {
				rotate(a = [0, 78.69006752597979, 36.86989764584402]) {
					cube(size = [0.125, 0.125, 5.0990195135927845]);
				}
			}
	...
	union() {
		...
		union() {
			...
			translate(v = [-5.5, 0.5, 3.5]) {
				rotate(a = [0, 105.79316904826398, 45.0]) {
			...
			translate(v = [-5.5, 0.5, 1.5]) {
				rotate(a = [0, 115.10409025022139, -51.34019174590991]) {
