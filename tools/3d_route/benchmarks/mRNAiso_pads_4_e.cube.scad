translate(v = [-0.5, -0.5, 0]) {
	...
	union() {
		...
		union() {
			...
			translate(v = [-0.5, 3.5, 2.5]) {
				rotate(a = [0, 115.2394018206789, -45.0]) {
	...
	union() {
		...
		union() {
			...
			translate(v = [0.5, 3.5, 2.5]) {
				rotate(a = [0, 56.309932474020215, -90.0]) {
	...
	union() {
		...
		union() {
			...
			translate(v = [0.5, 5.5, 5.5]) {
				rotate(a = [0, 127.9851672993556, -128.6598082540901]) {
			...
			translate(v = [0.5, 4.5, 1.5]) {
				rotate(a = [0, 90.0, -30.96375653207352]) {
